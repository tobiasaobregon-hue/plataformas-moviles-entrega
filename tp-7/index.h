...
<head>
  ...
  <title>TP7 - Estructura con Bootstrap</title>
  <!-- Bootstrap CSS CDN -->
  <link
...
<body>
  ...
  <header class="bg-light py-5">
    <div class="container text-center">
      <h1 class="display-4">Bienvenido a MiSitio</h1>
      <p class="lead">
        Este es un sitio web de ejemplo construido con Bootstrap para TP7.
      </p>
  ...
  <footer class="bg-primary text-white text-center py-3 mt-auto">
    <div class="container">
      <small>&copy; 2024 MiSitio. Todos los derechos reservados.</small>
    </div>
  </footer>
